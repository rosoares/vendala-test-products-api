...
3. Crie o arquivo **.env** (você pode utilizar o arquivo **.env.example** como ponto de partida)
4. Gerar a chave da aplicação `php artisan key:generate`
5. Gerar a chave do JWT `php artisan jwt:secret`
6. Crie um banco de dados no seu servidor MySQL.
7. Edite as variáveis de conexão com o banco de dados:
...
8. Rode o comando `php artisan migrate`
9. Rode o comando `php artisan colors:get` para pegar as cores da API pública do mercado livre
